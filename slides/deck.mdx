...
### You only have so much decision capital or willpower<br/> on a given day, make everything possible second nature.

- ### It’s modern today, maybe not tomorrow, welcome <br/>to the open plains of JavaScript

- ### The following opinions have an overarching theme, reducing your cognitive load.
